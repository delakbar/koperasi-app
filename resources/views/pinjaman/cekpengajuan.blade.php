                ...
                <tr>
                    ...
                    <td>
                        @if($pinjaman->status == 'Pengajuan')
                            <form action="{{ route('adminpinjaman.updateStatus', $pinjaman->id) }}" method="POST" style="display:inline-block;" class="form-terima">
                                @csrf
                                @method('PATCH')
                                <input type="hidden" name="status" value="Diterima Admin">
                                <button type="submit" class="btn btn-sm btn-success btn-terima">Terima</button>
                            </form>
                            <form action="{{ route('adminpinjaman.updateStatus', $pinjaman->id) }}" method="POST" style="display:inline-block;" class="form-tolak">
                                @csrf
                                @method('PATCH')
                                <input type="hidden" name="status" value="Ditolak Admin">
